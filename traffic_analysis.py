...
def main():
  ...
  if (args.input):
    ...
    if args.initial and args.final and args.n:
      intial = args.initial
      final = args.final
      n = args.n
      
      social_optima = helper.compute_social_optima(graph, intial,final,n)
      travel_eq = helper.compute_travel_eq(graph,intial,final,n)
